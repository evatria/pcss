...
public class UDPServer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            displayTimer = GameObject.FindGameObjectWithTag("DisplayTimer");
    ...
    void Winner()
    {
        ...
        {
            savePlayerName = clientList[0].clientName;
            winnerIs.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().text = savePlayerName;

            isRacing = false;
        }
        if (clientList[1].fishPrefab.GetComponent<Controller>().roundCount == 2)
        {
            savePlayerName = clientList[1].clientName;
            winnerIs.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().text = savePlayerName;
        ...
        if (clientList[2].fishPrefab.GetComponent<Controller>().roundCount == 2)
        {
            savePlayerName = clientList[2].clientName;
            winnerIs.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().text = savePlayerName;
        ...
        if (clientList[3].fishPrefab.GetComponent<Controller>().roundCount == 2)
        {
            savePlayerName = clientList[3].clientName;
            winnerIs.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().enabled = true;
            winnerName.GetComponent<Text>().text = savePlayerName;
