...
public class UDPClient : MonoBehaviour
{
    ...
    public void SendNameAndClient()
    {
        ...
        if (charText.text.Length >= 4)
        {
            ...
            sendIpAdress("IP," + clientIP, "Name," + charName);
        }
        else
        {
    ...
    private void ReceiveData()
    {
        ...
        try
        {
            ...
            string[] returnString = returnData.Split(',');

            fishX = returnString[0];
            print(fishX  + "UDP Client");
            fishZ = returnString[1];
            fishRotation = returnString[2];
    ...
    {
        if(clientInServer == true && fishCreated == false)
        {
            Instantiate(fishPrefab, fishPrefab.transform.position,Quaternion.identity);
